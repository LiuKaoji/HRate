...
extension UIButton {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(0), callback:(@escaping() -> ())) {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(0))-> Observable<Void> {
