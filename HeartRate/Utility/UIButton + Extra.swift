...
extension UIButton {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(150), callback:(@escaping() -> ())) {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(150))-> Observable<Void> {
