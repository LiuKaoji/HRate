...
extension UIButton {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(200), callback:(@escaping() -> ())) {
    ...
    func rxTapClosure(_ time: DispatchTimeInterval = .milliseconds(200))-> Observable<Void> {
