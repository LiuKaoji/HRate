...
//    //录音指示器
//    let updateHUD = PublishSubject<CGFloat>()
//
//    
...
//        }catch{
//            print("recorder init fail: \(error.localizedDescription)")
//        }
//    }
//    
//    // 请求录音权限
...
//        
//        // 发布音量数据
//        let volumeLevel = CGFloat(decibel) / CGFloat(INT64_MAX)
//        updateHUD.onNext(volumeLevel)
//    }
//    
//    // 暂停录音
//    func pauseRecording() {
